...
table 2: global sample across 5 quantiles of the outcome variables (in terms of main explanatory variables)
shows that lack of coping cap to climate risk seems to have sig. neg. effects in low quantiles and insig. effects in high quantiles (.75 and.9): increases in lack of coping cap/ toward climate risk looks to neg. affect financial development esp. in countries with low levels of finacial development 

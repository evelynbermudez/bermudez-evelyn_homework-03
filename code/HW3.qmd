...
## a. Table of models
```{r table-models-0-4}
table1 <- modelsummary::modelsummary(list("Null" = model0,
                                "Model 1" = model1,
                                "Model 2" = model2,
                                "Model 3" = model3,

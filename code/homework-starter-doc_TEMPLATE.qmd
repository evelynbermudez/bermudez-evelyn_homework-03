...
**sla and shoot_g is do not seem to be correlated, pearsons r is 0.348**  

**leaf_dry_weight_g and sla do not seem to be correlated, pearsons r is 0.033**  

**shoot mass and total mass seem to have a strong positive correlation, pearsons r is 0.902**
...
**Plants w/ larger biomass seem to have larger ranges. Grindelia has highest biomass, Acmispon has the lowest biomass.**
...
**Drought stressed plants are more likely to have a lower biomass compared to well watered plants. (which makes sense based on how plants work.**
...
** SLA and biomass in grams are not really correlated (visually). check correlation and see a that it does (stats).**

# Model construction

What is the null model?  

0. **total mass is not predicted by the water treatment, sla,and specie.**  
...
**reference for species_name:** **species_name amison glaber**  
